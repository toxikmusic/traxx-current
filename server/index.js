        ...
        switch (_a.label) {
            ...
            case 4:
                ...
                server.listen(port, "0.0.0.0", function () {
                    ...
                    (0, vite_js_1.log)("Server environment: ".concat(app.get('env')));
                    // Check if running in Replit
                    if (process.env.REPL_ID) {
                        (0, vite_js_1.log)("Running in Replit environment");
                        (0, vite_js_1.log)("REPL_SLUG: ".concat(process.env.REPL_SLUG || 'unknown'));
                        (0, vite_js_1.log)("REPL_OWNER: ".concat(process.env.REPL_OWNER || 'unknown'));
                    }
                });
                return [2 /*return*/];
        }
